...
class Tribe extends Component<any, any> {
    ...
    updateTribeFace(e:any, type:string) {
        let x;
        let y;
        if (type === 'mouse') {
        ...
        const faceWidth = face ? face.getBoundingClientRect().width : 0;
        const faceHeight = face ? face.getBoundingClientRect().height : 0;

        const noseWidth = nose ? nose.getBoundingClientRect().width : 0;
        const noseHeight = nose ? nose.getBoundingClientRect().height : 0;
        ...
        const foreHeadWidth = foreHead ? foreHead.getBoundingClientRect().width : 0;
        const foreHeadHeight = foreHead ? foreHead.getBoundingClientRect().height : 0;
        ...
        const hairWidth = hair ? hair.getBoundingClientRect().width : 0;
        const hairHeight = hair ? hair.getBoundingClientRect().height : 0;
        ...
        const frontHairWidth = frontHair ? frontHair.getBoundingClientRect().width : 0;
        const frontHairHeight = frontHair ? frontHair.getBoundingClientRect().height : 0;
        ...
        const leftMarkWidth = leftMark ? leftMark.getBoundingClientRect().width : 0;
        const leftMarkHeight = leftMark ? leftMark.getBoundingClientRect().height : 0;
        ...
        const rightMarkWidth = rightMark ? rightMark.getBoundingClientRect().width : 0;
        const rightMarkHeight = rightMark ? rightMark.getBoundingClientRect().height : 0;
        ...
        const leftEarWidth = leftEar ? leftEar.getBoundingClientRect().width : 0;
        const leftEarHeight = leftEar ? leftEar.getBoundingClientRect().height : 0;
        ...
        const rightEarWidth = rightEar ? rightEar.getBoundingClientRect().width : 0;
        const rightEarHeight = rightEar ? rightEar.getBoundingClientRect().height : 0;
